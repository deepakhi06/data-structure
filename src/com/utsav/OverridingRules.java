...
public class OverridingRules {
	...
	public static void main(String[] args) throws Exception {
		OverridingRules or = new OverridingRules();
		OverridingRules sc = new Subclass();
		
		or.superMethod();
		sc.superMethod();
	}
	
	public Object superMethod()throws IOException{
...
class Subclass extends OverridingRules{
	 ...
	 public String superMethod() throws IOException{
		System.out.println("Subclass method..");
		super.superMethod(); //Superclass method is called
		return new String();
	}
}
