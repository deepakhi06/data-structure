...
public class LinkedListDetectLoop {
	 ...
	 * 1-se two pointer fastPtr and slowPtr and initialize both to head of linkedlist 
	 ...
	 * 4-If fastPtr reaches to the end of linkedlist without meeting slow pointer then there
	 * is no loop in linkedlist (i.e fastPtr->next or fastPtr->next->next become
	 * null)
	 * 
	 * @return
	 */
